...
class Themo_Widget_Slider_Slick extends Widget_Base {

	public function get_name() {
		return 'themo-slider-slick';
	}

	public function get_title() {
		return __( 'Slider Slick', 'elementor' );
	}
	...
	protected function render() {
		...
		<div class="main-slick-slider">
			<?php foreach ( $settings['slides'] as $slide ) { ?>
				...
				<div class="elementor-repeater-item-<?php echo $slide['_id'] ?>">
		...
		<script type="text/javascript">
			jQuery( function ($) {
				$('.main-slick-slider').slick({
					<?php echo $settings['autoplay'] ? 'autoplay: true' : 'autoplay: false'; ?>,
					<?php echo ( $settings['animation'] == fade ? 'fade: true' : 'fade: false' ); ?>,
					easing : '<?php echo $settings['easing']; ?>',
					<?php echo $settings['animation_loop'] ? 'infinite: true' : 'infinite: false'; ?>,
					<?php echo $settings['smooth_height'] ? 'adaptiveHeight: true' : 'adaptiveHeight: false'; ?>,
					<?php echo ! $settings['slideshow_speed']['size'] ? 'autoplaySpeed: 3000' : 'autoplaySpeed: ' . $settings['slideshow_speed']['size']; ?>,
					<?php echo ! $settings['animation_speed']['size'] ? 'speed: 300' : 'speed: ' . $settings['animation_speed']['size']; ?>,
					<?php echo $settings['pause_on_hover'] ? 'pauseOnHover: true' : 'pauseOnHover: false'; ?>,
					<?php echo $settings['touch'] ? 'touchMove: true' : 'touchMove: false'; ?>,
					<?php echo $settings['direction'] ? 'arrows: true' : 'arrows: false'; ?>,
					<?php echo $settings['paging'] ? 'dots: true' : 'dots: false'; ?>
				});
			} );
		</script>
		<?php
...
Plugin::instance()->widgets_manager->register_widget_type( new Themo_Widget_Slider_Slick() );
