...
class Themovation_SO_WB_Package_Widget extends Themovation_Widget_Base {
	...
	function initialize() {
		...
		$this->register_frontend_styles(
			array(
				array( 'themo-package', plugin_dir_url(__FILE__) . 'styles/package.css', array(), ​THEMOVATION_WB_VER )
			)
		);
