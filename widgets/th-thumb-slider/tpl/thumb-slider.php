...
global $th_thumb_slider_count;

/** Existing Image Orientation Logic, feel free to use. */
$image_orientation = $instance['orientation'];
...
$unique_id = 'themo-thumb-slider-' . ++$th_thumb_slider_count;

echo '<div class="row">';
echo '<div id="' . $unique_id . '_inner" class="thumb-flex-slider flexslider flex-' . $image_orientation . ' col-xs-12">';
...
<script>
	...
	jQuery(window).load(function() {
		...
		themo_start_thumb_slider( '#<?php echo sanitize_html_class( $unique_id );?>_inner' );
	});
</script>
