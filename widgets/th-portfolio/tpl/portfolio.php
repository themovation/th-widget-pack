...
<div class="th-portfolio">

    <div id="filters" class="th-portfolio-filters">
        <span>Sort:</span>
        <a href="#" data-filter="*" class="current">All</a>
        <a href='#' data-filter='#portfolio_content .p-collaboration'>Collaboration</a>
        <a href='#' data-filter='#portfolio_content .p-development'>Development</a>
        <a href='#' data-filter='#portfolio_content .p-integration'>Integration</a>
    </div>

    <div id="th-portfolio-row" class="th-portfolio-row row portfolio_content four-columns">

        <div id="post-130" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-development p-integration post-130 status-publish format-standard has-post-thumbnail hentry themo_project_type-development themo_project_type-integration">
        ...
        <div id="post-121" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-collaboration p-development p-integration post-121 status-publish format-standard has-post-thumbnail hentry themo_project_type-collaboration themo_project_type-development themo_project_type-integration">
            <div class="th-port-wrap">
        ...
        <div id="post-128" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-development p-integration post-128 status-publish format-standard has-post-thumbnail hentry themo_project_type-development themo_project_type-integration">
            <div class="th-port-wrap">
        ...
        <div id="post-119" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-collaboration p-integration post-119 status-publish format-standard has-post-thumbnail hentry themo_project_type-collaboration themo_project_type-integration">
            <div class="th-port-wrap">
        ...
        <div id="post-123" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-collaboration p-development post-123 status-publish format-standard has-post-thumbnail hentry themo_project_type-collaboration themo_project_type-development">
            <div class="th-port-wrap">
        ...
        <div id="post-126" class="themo_portfolio type-themo_portfolio th-portfolio-item item col-lg-3 col-md-3 col-sm-6 p-collaboration p-integration post-126 status-publish format-standard has-post-thumbnail hentry themo_project_type-collaboration themo_project_type-integration">
            <div class="th-port-wrap">
