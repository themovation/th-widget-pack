            ...
            631: () => {
                jQuery(document).ready(function (t) {
                    ...
                    t("#ekit-admin-settings-form").on("submit", function (e) {
                        ...
                        t("#ekit-admin-license-form").on("submit", function (e) {
                            var i = t(this),
                                n = i.find(".ekit-admin-license-form-submit"),
                                o = i.serialize(),
                                r = i.find(".elementskit-license-form-result .attr-alert");
                            i.addClass("is-loading"),
                                n.find(".ekit-admin-save-icon").hide(),
                                t.post(
                                    ajaxurl + "?action=ekit_admin_license",
                                    o,
                                    function (t) {
                                        i.removeClass("is-loading"),
                                            n.removeAttr("disabled"),
                                            n.find(".ekit-admin-save-icon").fadeIn(),
                                            r.attr("class", "attr-alert attr-alert-" + t.status).html(t.message),
                                            1 == t.validate &&
                                                setTimeout(function () {
                        ...
                        t(".ekit-zoom-connection").on("click", function (t) {
                            t.preventDefault(),
                                jQuery.ajax({
                                    data: {},
                                    type: "post",
                                    ...
                                    beforeSend: function (t) {
                                        t.setRequestHeader("X-WP-Nonce", window.rest_config.nonce);
                                    },
                                    success: function (t) {
                                        alert(t.message);
                                    },
                        ...
                        t("#ekit_instagram_refresh_feed_btn").click(function (e) {
                            e.preventDefault();
                            var i = elementskit.resturl + "widget/instagram-feed/refresh_feed",
                                n = t("#ekit-admin-option-textuser__data__instragram____username__").val();
                            t.get("https://www.instagram.com/" + n + "/?__a=1", function (e) {
                                t.ajax({
                                    type: "POST",
                                    url: i,
                                    data: { content: e },
                        ...
                        t(document).on("click", "#dribble_access_btn", function (e) {
                            e.preventDefault();
                            var i = t(this),
                                n = t("#ekit-admin-option-textuser__data__dribble____client__id__").val(),
                                o = t("#ekit-admin-option-textuser__data__dribble____client__secret__").val(),
                                r = i.data("rest"),
                                s = i.data("nonce"),
                                a = (function (t) {
                                    var e,
                                        i = t <= 20 ? 20 : t,
                                        n = "ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz0123456789",
                                        o = n.length,
                                        r = "";
                                    for (e = 0; e < i; e++) r += n.charAt(Math.floor(Math.random() * o));
                                    return r;
                                })(20),
                                l = { uuid: a },
                                d = r + "elementskit/v1/dribble/redirect_uri",
                                c = "?client_id=" + n + "&cs=" + o + "&scope=public&state=" + JSON.stringify(l) + "&redirect_uri=" + d;
                            !(function (t, e, i, n) {
                                var o = o || screen.height / 2 - i / 2,
                                    r = r || screen.width / 2 - e / 2,
                                    s = window.open(t, "", "location=1,status=1,resizable=yes,width=" + e + ",height=" + i + ",top=" + o + ",left=" + r);
                                setTimeout(function a() {
                                    s && 0 == s.closed ? setTimeout(a, 100) : n && n();
                                }, 100);
                            })(r + "elementskit/v1/dribble/initiate" + c, 600, 500, function (e) {
                                var n = { tok_uuid: a };
                                jQuery.ajax({
                                    data: n,
                                    type: "post",
                                    url: r + "elementskit/v1/dribble/retrieve/",
                                    beforeSend: function (t) {
                                        t.setRequestHeader("X-WP-Nonce", s);
                                    },
                                    success: function (e) {
                                        e.success ? (t("#ekit-admin-option-textuser__data__dribble____access__token__").prop("disabled", !1).val(e.token), i.text("Refresh Access Token")) : alert("Failed to retrieve the token.");
                                    },
                                    error: function (t) {},
                                    complete: function () {},
                                });
