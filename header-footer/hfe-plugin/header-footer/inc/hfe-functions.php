 ...
 * @since  1.0.2
 */
function hfe_render_header() {thhf_render_sticky_header();  if(!hfe_header_enabled()){return false;}$transparent_header = get_post_meta(get_thhf_header_id(), "transparent-header", false);$render_class = $transparent_header ? "transparent-header" : "";thhf_render_sticky_header();  if(!hfe_header_enabled()){return false;}$transparent_header = get_post_meta(get_thhf_header_id(), "transparent-header", false);$render_class = $transparent_header ? "transparent-header" : "";
