...
class Product_Cart extends Widget_Base {
    ...
    public function get_title() {
        return __('Add to Cart', ALOHA_DOMAIN);
    }
    ...
    public function get_icon() {
        return 'th-editor-icon-product-cart';
    }
    ...
    protected function register_content_product_cart_controls() {
        ...
        $this->add_control(
                'section_box',
                [
                    'label' => __('Add to Cart', ALOHA_DOMAIN),
        ...
        $this->add_control(
                'show_price',
                [
                    'label' => __('Show Price', ALOHA_DOMAIN),
