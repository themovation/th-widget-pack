...
class Post_Media extends Widget_Base {
    ...
    public function get_title() {
        return __('Post Media', ALOHA_DOMAIN);
    }
    ...
    protected function register_content_post_media_standard_controls() {
        $this->start_controls_section(
                'section_standard',
                [
                    'label' => __('Standard & Image', ALOHA_DOMAIN),
                ]
        );
        ...
        $this->add_control(
                'image_note',
                [
                    //'label' => '<b>' . __('Note', ALOHA_DOMAIN) . '</b>',
                    'type' => \Elementor\Controls_Manager::RAW_HTML,
                    'raw' => __('Displays the featured image from the current post.', ALOHA_DOMAIN),
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'description' => __('Replaces missing Post Featured Image.', ALOHA_DOMAIN),
                ]
        );
    ...
    private function register_image_styles() {
        ...
        $this->add_control(
                'infinite',
                [
                    'label' => __('Infinite', ALOHA_DOMAIN),
        ...
        $this->add_control(
                'popup_switcher',
                [
                    'label' => __('Use popup', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
                    'return_value' => 'yes',
    ...
    protected function register_content_post_media_controls() {
        ...
        $this->add_control(
                ...
                [
                    //'label' => '<b>' . __('Note:', ALOHA_DOMAIN) . '</b>',
                    'type' => \Elementor\Controls_Manager::RAW_HTML,
                    'raw' => __('Displays the Post Format Media defined in the post settings.', ALOHA_DOMAIN),
                ]
        );
        ...
        $this->add_control(
                'test_type',
                [
                    'label' => __('Styling preview', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'standard',
                    'description' => __('Styling preview requires at least one published blog post with a corresponding format type set to work.', ALOHA_DOMAIN),
                    'options' => [
                        'standard' => __('Standard', ALOHA_DOMAIN),
                        'image' => __('Image', ALOHA_DOMAIN),
                        'video' => __('Video', ALOHA_DOMAIN),
                        'audio' => __('Audio', ALOHA_DOMAIN),
                        'quote' => __('Quote', ALOHA_DOMAIN),
                        'gallery' => __('Gallery', ALOHA_DOMAIN),
                        'link' => __('Link', ALOHA_DOMAIN),
                    ],
                ]
        );
        $this->end_controls_section();
