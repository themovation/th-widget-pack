...
class Product_Images extends Widget_Base {
    ...
    public function get_title() {
        return __('Product Images', ALOHA_DOMAIN);
    }
    ...
    protected function register_product_images_style_controls() {
        ...
        $this->add_control(
                'section_thumbnails',
                [
                    'label' => __('Thumbnails', ALOHA_DOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                ]
        );
        $this->add_responsive_control(
                'spacing',
                [
                    'label' => __('Top Margin', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'max' => 200,
        ...
        $this->add_responsive_control(
                'padding',
                [
                    'label' => __('Item Padding', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'range' => [
                        'px' => [
                            'max' => 100,
    ...
    protected function register_content_product_images_controls() {
        ...
        $this->add_control(
                ...
                [
                    ...
                    'raw' => __('Displays Product Gallery.', ALOHA_DOMAIN),
                ]
        );
        $this->end_controls_section();
    }
    ...
    private function renderGallery($imagePost) {
        ...
        if ($post_thumbnail_id) {
            ...
            $html .= sprintf('<img src="%s" alt="%s" class="wp-post-image" />', esc_url(wc_placeholder_img_src('woocommerce_single')), esc_html__('Awaiting product image', ALOHA_DOMAIN));
            $html .= '</div>';
        }
