...
class Post_Info extends Widget_Base {
    ...
    public function get_title() {
        return __('Post Info', ALOHA_DOMAIN);
    }
    ...
    */
    ...
    protected function register_post_info_controls() {
        ...
        $listing->add_control(
                'type',
                [
                    'label' => __('Type', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'author',
                    'options' => [
                        'author' => __('Author', ALOHA_DOMAIN),
                        'date' => __('Date', ALOHA_DOMAIN),
                        'time' => __('Time', ALOHA_DOMAIN),
                        'comments' => __('Comments', ALOHA_DOMAIN),
                        'taxonomy' => __('Taxonomies', ALOHA_DOMAIN),
                    ],
                ]
        );
        $listing->add_control(
                'taxonomy',
                [
                    'label' => __('Taxonomy', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                'name_type',
                [
                    'label' => __('Name Type', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'nickname',
                    'options' => [
                        'nickname' => __('Nickname', ALOHA_DOMAIN),
                        'user_nicename' => __('Username', ALOHA_DOMAIN),
                        'display_name' => __('Display Name', ALOHA_DOMAIN),
                        'first_name' => __('First Name', ALOHA_DOMAIN),
                        'last_name' => __('Last Name', ALOHA_DOMAIN),
                        'full_name' => __('Full Name', ALOHA_DOMAIN),
                    ],
                    'condition' => [
                        'type' => 'author',
                    ],
        ...
        $listing->add_control(
                'show_icon',
                [
                    'label' => __('Show Icon', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                'show_avatar',
                [
                    'label' => __('Show Avatar', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                'show_link_author',
                [
                    'label' => __('Show Link', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                'show_link_comments',
                [
                    'label' => __('Link to comments', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
    ...
    protected function register_post_info_style_controls() {
        ...
        $this->add_responsive_control(
                'element_spacing',
                [
                    'label' => __('Elements Spacing', ALOHA_DOMAIN),
        ...
        $this->add_responsive_control(
                'icon_spacing',
                [
                    'label' => __('Icon Spacing', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => ['%'],
                    'selectors' => [
                        ...
                        <div class="elementor-icon thmv-icon">
                            ...
                            if(!empty($item['show_icon'])){
                                ...
                                if ($avatar) {
                                    ...
                                    echo '<img src="' . $avatar . '" alt="' . __('author image', ALOHA_DOMAIN) . '">';
                                } else {
