...
class Post_Navigation extends Widget_Base {
    ...
    public function get_title() {
        return __('Post Navigation', ALOHA_DOMAIN);
    }
    ...
    */
    ...
    protected function register_content_post_navigation_controls() {
        $this->start_controls_section(
                ...
                [
                    'label' => __('Navigation', ALOHA_DOMAIN),
                ]
        );
        ...
        $this->add_control(
                'hide_title',
                [
                    'label' => __('Custom Labels', ALOHA_DOMAIN),
        ...
        $this->add_control(
                'label_previous',
                [
                    'label' => __('Previous Label', ALOHA_DOMAIN),
        ...
        $this->add_control(
                'label_next',
                [
                    'label' => __('Next Label', ALOHA_DOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('Next'),
                    'condition' => [
                        'hide_title!' => '',
        ...
        $this->add_control(
                'stack_phone',
                [
                    'label' => __('Stack on mobile', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
                    'return_value' => 'yes',
